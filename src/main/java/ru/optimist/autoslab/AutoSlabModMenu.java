...
public class AutoSlabModMenu implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            general.addEntry(eb.startKeyCodeField(Text.translatable("key.autoslab.activate"), currentBoundKey(activateKey))
    ...
    private static net.minecraft.client.util.InputUtil.Key currentBoundKey(KeyBinding binding) {
